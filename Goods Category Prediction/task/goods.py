...
def main():
    ...
    # Loading train_df.pkl from the data directory
    train_df = pd.read_pickle("data/train_df.pkl")

    # Loading test_df.pkl from the data directory
    test_df = pd.read_pickle("data/test_df.pkl")

    # Loading train_labels.pkl from the data directory
    ...
    #saving the rf_model as pickle files in the data directory
